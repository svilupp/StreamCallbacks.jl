...
pkg_name = "StreamCallbacks.jl" # Base.current_project()
purpose = "Library to unify streaming interfaces for LLMs across many providers. It is currently used by PromptingTools.jl to support streaming"
